...
const clubsData = [
  {
    ...
    description: "Advanced programming and software development community",
  ...
  },
  {
    ...
    description: "Google technologies and cloud development enthusiasts",
  ...
  },
  {
    ...
    description: "Data analytics, machine learning, and AI research hub",
  ...
  {
    name: "Fetch.AI-AIML",
    description: "Artificial Intelligence and Machine Learning pioneers",
  ...
  },
  {
    ...
    description: "Cybersecurity research and ethical hacking community",
  ...
  },
  {
    ...
    description: "Business innovation and startup development community",
...
function createClubCard(club, index) {
  ...
  colDiv.innerHTML = `
    <div class="card h-100 shadow-lg border-0" style="border-left: 5px solid var(--bs-${club.color}) !important; border-radius: 15px;">
      <div class="card-header bg-${club.color} text-white" style="border-radius: 15px 15px 0 0;">
        <div class="d-flex align-items-center">
          ...
          <div>
            ...
            <small class="text-white-50">${club.category} • ${club.members} Members</small>
          </div>
        </div>
      </div>
      <div class="card-body p-4">
        ...
        <div class="mb-3">
          ...
          <div class="d-flex flex-wrap gap-1">
            ...
            ${club.activities.length > 3 ? `<span class="badge bg-secondary bg-opacity-10 text-secondary small px-2 py-1">+${club.activities.length - 3} more</span>` : ''}
          </div>
        </div>
        ...
        <div class="mb-4">
          ...
          <div class="outcomes-list">
            ${club.outcomes.slice(0, 3).map(outcome => 
            ...
            ${club.outcomes.length > 3 ? 
              `<div class="d-flex align-items-center mb-1">
                ...
                <small class="text-secondary">${club.outcomes.length - 3} more achievements</small>
              </div>` : ''
            }
          </div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="text-center">
            ...
            <small class="text-${club.color}">${club.meetingDay}s ${club.meetingTime}</small>
          </div>
          <button class="btn btn-${club.color} btn-sm px-3 shadow-sm" onclick="showClubDetails('${club.name}')">
